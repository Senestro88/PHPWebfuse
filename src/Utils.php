...
class Utils {
     ...
     * @param string $start The substring to check for at the beginning of $string.
     ...
     * @param string $end The substring to check for at the end of $string.
     * @param string $string The string to check.
    ...
    public static function registerErrorHandler(): void {
        @set_error_handler(function(int $errno, string $errstr, string $errfile, int $errline) {
                    ...
                    $errorFilename = Path::insert_dir_separator(PHPWebfuse['directories']['root']) . "\$error-messages.log";
    ...
    public static function registerExceptionHandler(): void {
        @set_exception_handler(function(\Throwable $ex) {
                    $exceptionFilename = Path::insert_dir_separator(PHPWebfuse['directories']['root']) . "\$exception-messages.log";
     ...
     */
    public static function throwException(string $message, int $code = 0, ?\Throwable $previous = null): \PHPWebfuse\Instance\Exceptions\Exception {
        return new \PHPWebfuse\Instance\Exceptions\Exception($message, $code, $previous);
    }
     ...
     */
    public static function throwIOException(string $message, int $code = 0, ?\Throwable $previous = null): \PHPWebfuse\Instance\Exceptions\IOException {
        return new \PHPWebfuse\Instance\Exceptions\IOException($message, $code, $previous);
    }
     ...
     */
    public static function throwInvalidArgumentException(string $message, int $code = 0, ?\Throwable $previous = null): \PHPWebfuse\Instance\Exceptions\InvalidArgumentException {
        return new \PHPWebfuse\Instance\Exceptions\InvalidArgumentException($message, $code, $previous);
    }
